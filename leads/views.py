...
class LeadListView(ListView):
    ...
    # The context is automatically passed as object_list
    # context = {"leads": queryset}
    # we can also specify context name as:
...
class LeadCreateView(CreateView):
    ...
    def form_valid(self, form):
        ...
        send_mail(
            ...
            from_email="ltestypy@gmail.com",
            recipient_list=["omkar007@live.com"]
        )
...
def lead_create(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            # save method is only in ModelForm and
            # not availabe in normal Forms
            form.save()
